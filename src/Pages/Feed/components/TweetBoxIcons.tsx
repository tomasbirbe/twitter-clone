...
const TweetBoxIcons = () => (
  <Stack direction="row" align="center" justify="space-between" paddingInlineEnd={2} borderBlock="1px" paddingBlock={3} borderColor="gray.100">
    ...
    <Stack>
      <TwButton color="white" bg="blue.500" height="35px">Tweet</TwButton>
    </Stack>
  </Stack>
